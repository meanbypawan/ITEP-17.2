...
function HeaderComponent(){
    ...
    headerContainer.setAttribute("class","bg-dark d-flex justify-content-between align-items-center");
    ...
    logoLabel.innerHTML = "<b class='text-white'><span class='text-danger'>E-shop</span></b><h6 class='text-white text-center'>Shop on a single click</h6>" 
    
    logoDiv.appendChild(logoLabel);
   
    let searchBox = document.createElement("div");
    searchBox.setAttribute("style","width:40%;height:50px;");
    searchBox.setAttribute("class","d-flex justify-content-center align-items-center")
...
function CardComponent(){
   ...
   for(let product of productList){
     ...
     cardContent.setAttribute("style","height:400px;box-shadow: 10px 10px 10px grey;")
     cardContent.setAttribute("class","d-flex flex-column align-items-center")
     let img = document.createElement("img");
     img.setAttribute("style","height:250px;width:100%");
     ...
     viewMoreButton.setAttribute("class","btn btn-warning");
     viewMoreButton.setAttribute("style","width:90%;");
    
     viewMoreButton.addEventListener("click",function(){
        ViewMoreComponent(product);
     });

     cardContent.appendChild(viewMoreButton);
